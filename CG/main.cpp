...
int t=20;
float _move = 0.0f,_mover = 0.0f,_move1 = 0.0f,_move2 = 0.0f,_movep=0.0f,_moveCNG=0.0f,_moveTrain=0.0f;
...
void Light(void){
    ...
    glColor3ub(0,0,0);
    glBegin(GL_POLYGON);
    glVertex3f(xlight+0.015,0.07,0.0);
    glVertex3f(xlight,0.07,0.0);
    glVertex3f(xlight,-0.23,0.0);
    glVertex3f(xlight+0.015,-0.23,0.0);
    glEnd();
    glPopMatrix();
    //light
    glPushMatrix();
    ...
    glVertex3f(xlight,0.07,0.0);
    glVertex3f(xlight+0.015,0.07,0.0);
    glVertex3f(xlight+0.075,0.1,0.0);
    glVertex3f(xlight+0.065,0.1,0.0);
    glVertex3f(xlight,0.08,0.0);
    glEnd();
    glPopMatrix();
    ...
    glVertex3f(xlight+0.075,0.1,0.0);
    glVertex3f(xlight+0.015,0.07,0.0);
    glVertex3f(xlight+0.015,0.055,0.0);
    glVertex3f(xlight+0.075,0.075,0.0);
    glEnd();
    glPopMatrix();
    xlight+=0.6;
    }
...
void Light1(void){
    ...
    glColor3ub(0,0,0);
    glBegin(GL_POLYGON);
    glVertex3f(xlight1+0.015,0.07-0.42,0.0);
    glVertex3f(xlight1,0.07-0.42,0.0);
    glVertex3f(xlight1,-0.23-0.42,0.0);
    glVertex3f(xlight1+0.015,-0.23-0.42,0.0);
    glEnd();
    glPopMatrix();
    //light
    glPushMatrix();
    ...
    glVertex3f(xlight1,0.07-0.42,0.0);
    glVertex3f(xlight1+0.015,0.07-0.42,0.0);
    glVertex3f(xlight1+0.075,0.1-0.42,0.0);
    glVertex3f(xlight1+0.065,0.1-0.42,0.0);
    glVertex3f(xlight1,0.08-0.42,0.0);
    glEnd();
    glPopMatrix();
    ...
    glVertex3f(xlight1+0.075,0.1-0.42,0.0);
    glVertex3f(xlight1+0.015,0.07-0.42,0.0);
    glVertex3f(xlight1+0.015,0.055-0.42,0.0);
    glVertex3f(xlight1+0.075,0.075-0.42,0.0);
    glEnd();
    glPopMatrix();
    xlight1+=0.6;
    }
...
void Train(void){
    ...
    glColor3ub(255,255,255);
        glBegin(GL_POLYGON);
        glVertex3f(xt,0.06,0.0f);
        glVertex3f(xt-0.02,0.0,0.0f);
        glVertex3f(xt+0.8,0.0,0.0f);
        glVertex3f(xt+0.8f,0.18f,0.0f);
        glVertex3f(xt,0.18,0.0f);
        glEnd();
    glPopMatrix();
    //train chimney
    glPushMatrix();
        glBegin(GL_QUADS);
        glColor3ub(0,0,0);
        glVertex3f(xt+0.08,0.18+0.05,0.0f);
        glVertex3f(xt+0.05,0.18+0.05,0.0f);

        glColor3ub(127,127,127);
        glVertex3f(xt+0.05,0.18,0.0f);
        glVertex3f(xt+0.08,0.18,0.0f);
        glEnd();
    glPopMatrix();
    //Train Divider
    glPushMatrix();
        glBegin(GL_LINES);
        glColor3ub(0,0,0);
        glVertex3f(xt+0.04,0.18f,0.0f);
        glVertex3f(xt+0.04,0.0f,0.0f);
        glEnd();
    glPopMatrix();
    //Train Wondow
    //Front
    glPushMatrix();
        glBegin(GL_POLYGON);
        glColor3ub(0,0,0);
        glVertex3f(xt+0.03,0.17f,0.0f);
        glVertex3f(xt+0.004,0.17f,0.0f);
        glVertex3f(xt+0.004,0.06f,0.0f);
        glVertex3f(xt+0.03,0.06f,0.0f);
        glEnd();
    glPopMatrix();
    for(float i=0.0f;i<0.75;i+=0.05){
    glPushMatrix();
    glTranslatef(i,0.0f,0.0f);
        if(i==0){
            glBegin(GL_QUADS);
            glColor3ub(0,0,0);
            glVertex3f(xt+0.09,0.18-0.02,0.0f);
            glVertex3f(xt+0.05,0.18-0.02,0.0f);
            glVertex3f(xt+0.05,0.18-0.16,0.0f);
            glVertex3f(xt+0.09,0.18-0.16,0.0f);
            glEnd();
        glPopMatrix();
            ...
            glVertex3f(xt+0.09,0.18-0.02,0.0f);
            glVertex3f(xt+0.05,0.18-0.02,0.0f);
            glVertex3f(xt+0.05,0.18-0.1,0.0f);
            glVertex3f(xt+0.09,0.18-0.1,0.0f);
            glEnd();
        glPopMatrix();
        }
    }
...
*/
	...
	glutTimerFunc(30, updateTrain, 0); //Notify GLUT to call update again in 25 milliseconds
}
...
//	PlaySound("toolur_d7y5ZO.wav", NULL,SND_ASYNC|SND_FILENAME|SND_LOOP);
//	PlaySound("Passing car horn sound effect.wav", NULL,SND_ASYNC|SND_FILENAME|SND_LOOP);
